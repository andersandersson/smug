...
/** \brief A struct for the node type in a linked list.
*
...
/** \brief A struct for a linked list.
*
...
/** \brief Creates and returns a new empty node
* \relatesalso Node
*/
Node* Node_new();
...
/** \brief Adds the passed item to a new node at the end of the list.
* \relatesalso LinkedList
*/
void LinkedList_addLast(LinkedList* list, void* item);

/** \brief Calls the passed function on every data item in the list.
* \relatesalso LinkedList
*/
void LinkedList_traverse(LinkedList* list, void (*func)(void*));

/** \brief Removes the passed node from the list. Does not delete the contents of the node!
* \relatesalso LinkedList
*/
...
* 
* Calls the passed function on every data item in the list and then empties the list. Assumes the passed function deletes the stored datatype correctly.
* \relatesalso LinkedList
*/
