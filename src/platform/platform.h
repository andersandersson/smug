...
#define MOUSE_AXIS_BASE 15
#define MOUSE_AXIS_ABSX MOUSE_AXIS_BASE-0
#define MOUSE_AXIS_ABSY MOUSE_AXIS_BASE-1
#define MOUSE_AXIS_RELX MOUSE_AXIS_BASE-2
#define MOUSE_AXIS_RELY MOUSE_AXIS_BASE-3
#define MOUSE_AXIS_ABSWHEEL MOUSE_AXIS_BASE-4
#define MOUSE_AXIS_RELWHEEL MOUSE_AXIS_BASE-5
...
#define MOUSE_LAST MOUSE_AXIS_BASE

// Joystick axis identifiers
#define JOYSTICK_AXIS_BASE 31
#define JOYSTICK_AXIS_1X JOYSTICK_AXIS_BASE-0
#define JOYSTICK_AXIS_1Y JOYSTICK_AXIS_BASE-1
#define JOYSTICK_AXIS_2X JOYSTICK_AXIS_BASE-2
#define JOYSTICK_AXIS_2Y JOYSTICK_AXIS_BASE-3
